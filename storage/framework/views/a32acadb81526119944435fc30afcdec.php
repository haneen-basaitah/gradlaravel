        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('patients.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?> <!-- حماية من هجمات CSRF -->
                    ...
                    <div class="text-center">
                        ...
                        <a href="<?php echo e(route('patients.view')); ?>" class="btn btn-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('dashboard.layout.app', ['title' => 'Add Elderly'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\graduations\laravel\medimind\resources\views/dashboard/layout/patients/add.blade.php ENDPATH**/ ?>